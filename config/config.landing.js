export default {
    ...
    APP_ENTRY_DIRECTORY: './src/landing',
  
    // APP CONFIG FOLDER URL
    APP_CONFIG_DIRECTORY: './src/landing/config',
  
    // APP SHARED COMPONENTS FOLDER URL
    APP_SHARED_COMPONENTS_DIRECTORY: './src/shared/components',
  
    // APP COMPONENTS FOLDER URL
    APP_COMPONENTS_DIRECTORY: './src/landing/app/components',
  
    // APP PAGES FOLDER URL
    APP_PAGES_DIRECTORY: './src/landing/app/pages',
    ...
    ASSETS_DIRECTORY: './src/landing/assets',
